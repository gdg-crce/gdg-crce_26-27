export interface GDGEvent {
  ...
  subtitle: string;
  posterImage: string;
  /** [x, y, z] position on wall. z should be ~0.025 to sit proud of wall surface. */
